...
from typing import Optional, List, Union, Dict, Any, Protocol
...
class AgentIdentity:
    ...
    deployment_id: Optional[str] = None  # e.g., "api-prod-us-east-1"
    
    def to_spiffe_id(self, trust_domain: Optional[str] = None) -> str:
...
class AgentIntegrity:
    ...
    """
    config_hash: Optional[str] = None        # SHA256 of config
    system_prompt_hash: Optional[str] = None # SHA256 of system prompt
...
class ConfirmationKey:
    ...
    tls_binding: Optional[Dict[str, str]] = None  # Reserved for future
...
class AttestationClaims:
    ...
    aud: Union[str, List[str]]         # Audience (target server)
    ...
    agent_integrity: Optional[AgentIntegrity] = None
    cnf: Optional[ConfirmationKey] = None
...
class KeyPair:
    ...
    @classmethod
    def generate(cls, kid: Optional[str] = None) -> "KeyPair":
...
class AttestationVerifier:
    ...
    async def verify(self, token: Optional[str]) -> VerificationResult:
        """
